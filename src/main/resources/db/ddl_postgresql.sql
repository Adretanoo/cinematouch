...
CREATE
OR REPLACE VIEW vw_session_details AS
...
CREATE
OR REPLACE VIEW vw_ticket_info AS
...
CREATE
OR REPLACE VIEW vw_order_summary AS
...
CREATE
OR REPLACE VIEW vw_order_food_details AS
SELECT ofi.order_id,
...
CREATE
OR REPLACE VIEW vw_active_promotions AS
SELECT id,
       name,
       discount_percent,
       start_date,
